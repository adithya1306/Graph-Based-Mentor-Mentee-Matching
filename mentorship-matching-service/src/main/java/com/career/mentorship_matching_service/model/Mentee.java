...
public class Mentee {
    ...
    @Relationship(type = "MENTORED_BY", direction = Relationship.Direction.OUTGOING)
    ...
    public Mentee(String id, String name, String email, List<Skill> skills, Industry industry) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.skills = skills;
